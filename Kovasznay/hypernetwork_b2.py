...
class HyperNetwork(nn.Module):
    ...
    def loss_func(self):
        ...
        for i,re in enumerate(self.train_Res):
            ...
            a = 20-i%20
            train_loss += a*(loss)/len(self.train_Res)
        ...
        for i,re in enumerate(self.val_Res):
            ...
            a = 20-i%20
            val_loss += a*(loss)/len(self.val_Res)
    ...
    def predict(self,X):
        ...
        return u_predict, v_predict, p_predict, weights
...
u_predict, v_predict, p_predict, _ = model_hypernetwork.predict(X)
