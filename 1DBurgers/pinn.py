...
class Base_Net(nn.Module):
  ...
  class VPNSFNet():
    def __init__(self, xb_train, yb_train, u_train, x_train, y_train, layers, nu = 1e-2):  
        ...
        self.optimizer2 = torch.optim.LBFGS(self.dnn.parameters(), lr=0.1,max_iter=5000,tolerance_grad=1e-10)
        self.scheduler = torch.optim.lr_scheduler.MultiStepLR(self.optimizer1, milestones=[10000,15000,20000,25000], gamma=0.1)
